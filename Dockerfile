...
RUN echo '#!/bin/bash\n\
# Фікс прав доступу для CUPS перед стартом\n\
...
sleep 2\n\
\n\
# Дозволяємо віддалене керування та спільний доступ\n\
...
\n\
# Явно вказуємо, що принтер спільний та приймає завдання\n\
